...
def to_flexible_regex(text: str) -> str:
    ...
    先頭固定（^）は付けない。
    そのため「694 1056」で「REV694-1056」など、途中一致もヒットする。

    例:
      REV757_0200_AA_00  -> REV757[-_\\x20\\x{3000}]0200...
      REV757 1055        -> REV757[-_\\x20\\x{3000}]1055
      694 1056           -> 694[-_\\x20\\x{3000}]1056
        （REV694-1056 / REV694_1056 などにもヒット）
    """
    parts = []
...
class EverythingSearchApp:
    ...
    def _build_help_tab(self):
        ...
        usage = (
            ...
            "・例: 「694 1056」→ REV694-1056 / REV694_1056 などにもヒット\n"
            "・例: 「REV757_0200」→ REV757-0200 にもヒット\n"
            "\n"
            "【準備（初回のみ）】\n"
